 ...
 */
            ...
            // Store local spin in S and local field in H  ***HACK***
            const double S[3] = {atoms::x_spin_array[atom]*mu,atoms::y_spin_array[atom]*mu,atoms::z_spin_array[atom]*mu};
            const double H[3] = {
                atoms::x_total_external_field_array[atom],
                atoms::y_total_external_field_array[atom],
                atoms::z_total_external_field_array[atom]
            };
